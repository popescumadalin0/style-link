    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HairStylistSalon", x => new { x.HairStylistsId, x.SalonsId });
                    table.ForeignKey(
                        name: "FK_HairStylistSalon_HairStylists_HairStylistsId",
                        column: x => x.HairStylistsId,
                        principalTable: "HairStylists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HairStylistSalon_Salons_SalonsId",
                        column: x => x.SalonsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HairStylistServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HairStylistServices_HairStylists_HairStylistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_HairStylistServices_HairStylistServiceId",
                        column: x => x.HairStylistServiceId,
                        principalTable: "HairStylistServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_HairStylistServiceId",
                table: "Appointments",
                column: "HairStylistServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HairStylistSalon_SalonsId",
                table: "HairStylistSalon",
                column: "SalonsId");

            migrationBuilder.CreateIndex(
                name: "IX_HairStylistServices_HairStylistId",
                table: "HairStylistServices",
                column: "HairStylistId");

            migrationBuilder.CreateIndex(
                name: "IX_HairStylistServices_ServiceId",
                table: "HairStylistServices",
                column: "ServiceId");
